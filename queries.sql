...
VALUES (2, '🎨 Design Workshop"', 'June 10, 2025', 'Creative Hub');

insert INTO saving (user_id, goal, targetAmount, savedAmount)
VALUES (1, '🌴 Dream Vacation', 4500, 1875);

ALTER TABLE transaction
    ADD COLUMN description TEXT;

INSERT INTO transaction (user_id, amount, expenses, type, description)
VALUES (1, 3450.75, 20000, 'expense', '💼 Salary (Freelance)');
...
INSERT INTO transaction (user_id, description, amount, type, date)
VALUES (1, '💼 Salary (Freelance)', 3450.75, 'income', '2026-05-01'),
...
ALTER TABLE events ADD COLUMN description VARCHAR(250);
